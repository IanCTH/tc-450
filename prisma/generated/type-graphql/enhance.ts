...
const inputsInfo = {
  ...
  PostWhereInput: ["AND", "OR", "NOT", "id", "title", "content", "published", "authorId", "author"],
  PostOrderByWithRelationInput: ["id", "title", "content", "published", "authorId", "author"],
  PostWhereUniqueInput: ["id", "AND", "OR", "NOT", "title", "content", "published", "authorId", "author"],
